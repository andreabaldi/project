...
$pdf->write2DBarcode($vid.' '.$vnome.' '.$vcognome, 'QRCODE,H', 20, 38, 24, 24, $style, 'N');

$pdf->setTextColor(115,66,34);
$pdf->Text(10, 25, $nome.$vnome);
$pdf->Text(10, 30, $cognome.$vcognome);
$pdf->Text(10, 20, $tessera);
...
// Test the call
//CreateTessera(12345,12345,"Andrea", "Baldi","2022-04-30");